...
public class Logger {
    public static let shared = Logger(topLevel: .info)
    ///When `true`, logs will also appear in the physical device's logs.
    public var logsIntoConsole: Bool = false
    
    public var topLevel: LogLevel
    ...
    public init(topLevel: LogLevel = .info) {
        self.topLevel = topLevel
    }
    
    public func log(_ message: String, level: LogLevel = .info, function: String = #function, file: String = #file, line: Int = #line) {
    ...
    public func logAndFail(_ message: String, level: LogLevel = .info, function: String = #function, file: String = #file, line: Int = #line) {
    ...
    public func assert(_ condition: Bool, failureMessage message: String, level: LogLevel = .info, function: String = #function, file: String = #file, line: Int = #line) {
